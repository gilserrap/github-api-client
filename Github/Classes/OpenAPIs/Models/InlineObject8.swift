...
public struct InlineObject8: Codable {
    ...
    public init(name: String, script: String, scriptRepository: [String:String], environment: [String:String], enforcement: String? = nil, allowDownstreamConfiguration: Bool? = nil) {
        self.name = name
        self.script = script
