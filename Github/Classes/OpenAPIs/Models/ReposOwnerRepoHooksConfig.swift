//
// ReposOwnerRepoHooksConfig.swift
//
...
public struct ReposOwnerRepoHooksConfig: Codable {
    ...
    public init(url: String, contentType: String? = nil, secret: String? = nil, insecureSsl: String? = nil, token: String? = nil, digest: String? = nil) {
        self.url = url
