...
/** Issue Simple */
public struct IssueSimple: Codable {
    ...
    public init(id: Int, nodeId: String, url: String, repositoryUrl: String, labelsUrl: String, commentsUrl: String, eventsUrl: String, htmlUrl: String, number: Int, state: String, title: String, body: String? = nil, user: SimpleUser?, labels: [Label], assignee: SimpleUser?, assignees: [SimpleUser]? = nil, milestone: Milestone?, locked: Bool, activeLockReason: String? = nil, comments: Int, pullRequest: IssueSimplePullRequest? = nil, closedAt: Date?, createdAt: Date, updatedAt: Date, authorAssociation: AuthorAssociation, bodyHtml: String? = nil, bodyText: String? = nil, timelineUrl: String? = nil, repository: Repository? = nil, performedViaGithubApp: Integration? = nil) {
        self.id = id
        self.nodeId = nodeId
        self.url = url
